                        ...
                        <div class="col-8">
                            <div class="card mg-b-30">
                                ...
                                <div class="card-body pd-0">
                                    <div class="d-flex justify-content-between align-items-center">
                                        <form action="admin/setbonus" method="post">
                                            <label><label>1GRD=<?=Option::get('bonPrice')?>USD </label>
                                                <input type="text" name="price"
                                                    placeholder="<?=Option::get('bonPrice')?>">

                                                <br>

                                                <label>Amount of GRD= <?=round(Option::get('bonAmount'),2)?></label>
                                                <input type="number" name="amount"
                                                    placeholder="<?=round(Option::get('bonAmount'),2)?>" min="0">
                                                <br>
                                                <label>Status= </label>
                                                <select name="status" required>
                                                    <option value="on"
                                                        <?=(Option::get('bonStatus')=='on')?'selected':''?>>On</option>
                                                    <option value="off"
                                                        <?=(Option::get('bonStatus')!='on')?'selected':''?>>Off</option>
                                                </select>
                                                <br>
                                    ...
                                    <div class="d-flex justify-content-between align-items-center">
                                        <form action="admin/setbonus" method="post">
                                            <label><label>Current ammount <?=Option::get('bonOneHand')?> GRD </label>
                                                <input type="text" name="bonOneHand"
                                                    placeholder="<?=Option::get('bonOneHand')?>">
                    ...
                    <div class="row clearfix">
                        <div class="col-12">
                            ...
                            <div class="card mg-b-30">
                                <div class="card-header">
                                    <div class="d-flex justify-content-between align-items-center">
                                        <h6 class="card-header-title tx-13 mb-0 text-uppercase">Bonus token purchses
                                        </h6>
