                                ...
                                <div class="card mg-b-30">
                                    <div class="card-header">
                                        <div class="d-flex justify-content-between align-items-center">
                                            <h6 class="card-header-title tx-13 mb-0 text-uppercase">Set GRD2
                                            </h6>
                                    ...
                                    <div class="card-body pd-0">
                                        <div class="d-flex justify-content-between align-items-center">
                                            <form action="admin/set_tok2" method="post">
                                                <label>1 GRD2 = <?=Option::get('tok2_price')?> USD </label>
                                                    <input type="text" name="tok2_price"
                                                        placeholder="<?=Option::get('tok2_price')?>">
                                                    <br>

                                                <!--<label>Current sum = <?=Option::get('tok2_sum')?> GRD2 </label>
                                                    <input type="text" name="tok2_sum"
                                                        placeholder="<?=Option::get('tok2_sum')?>">
                                                    <br>-->

                                                <label>Goal sum = <?=Option::get('tok2_goal')?> GRD2 </label>
                                                    <input type="text" name="tok2_goal"
                                                        placeholder="<?=Option::get('tok2_goal')?>">
                                                    <br>
                                        ...
                                        <!--<hr>
                                        <h5>Set "in one hand" ammount</h5>
                                        <div class="d-flex justify-content-between align-items-center">
                                            <form action="admin/set_tok2" method="post">
                                                <label>Current ammount <?=Option::get('tok2OneHand')?> GRD </label>
                                                    <input type="text" name="tok2OneHand"
                                                        placeholder="<?=Option::get('tok2OneHand')?>">
                    ...
                    <div class="row clearfix">
                        <div class="col-12">
                            ...
                            <div class="card mg-b-30">
                                <div class="card-header">
                                    <div class="d-flex justify-content-between align-items-center">
                                        <h6 class="card-header-title tx-13 mb-0 text-uppercase">GRD2 purchses
                                        </h6>
