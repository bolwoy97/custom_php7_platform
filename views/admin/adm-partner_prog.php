                            ...
                            <div class="card mg-b-30">
                                <div class="card-header">
                                    <div class="d-flex justify-content-between align-items-center">
                                        <h6 class="card-header-title tx-13 mb-0 text-uppercase">Set partner program
                                        </h6>
                                ...
                                <div class="card-body pd-0">
                                    <?if(!$cur_partner_prog){?>
                                    <div class="d-flex justify-content-between align-items-center">
                                        <form action="adm_set_partner_prog" method="post">
                                            <label>Start </label>
                                    ...
                                    <div class="d-flex justify-content-between align-items-center">
                                        ...
                                        Start: <?=$cur_partner_prog['start']?><br>
                                        End: <?=$cur_partner_prog['end']?>
                                        <hr>
                    ...
                    <div class="row clearfix">
                        <div class="col-8">
                            <div class="card mg-b-30">
                                <div class="card-header">
                                    <div class="d-flex justify-content-between align-items-center">
                                        <h6 class="card-header-title tx-13 mb-0 text-uppercase">apply bonus
                                        </h6>
                    ...
                    <div class="row clearfix">
                        <div class="col-12">
                            ...
                            <div class="card mg-b-30">
                                <div class="card-header">
                                    <div class="d-flex justify-content-between align-items-center">
                                        <h6 class="card-header-title tx-13 mb-0 text-uppercase">Leaders
                            ...
                            <div class="card mg-b-30">
                                <div class="card-header">
                                    <div class="d-flex justify-content-between align-items-center">
                                        <h6 class="card-header-title tx-13 mb-0 text-uppercase">Current referal program
                                            purchases
                                        </h6>
                                        <div class="text-right">
                                            <div class="d-flex">
                            ...
                            <div class="card mg-b-30">
                                <div class="card-header">
                                    <div class="d-flex justify-content-between align-items-center">
                                        <h6 class="card-header-title tx-13 mb-0 text-uppercase">All referal program
                                            purchases
                                        </h6>
                                        <div class="text-right">
                                            <div class="d-flex">
