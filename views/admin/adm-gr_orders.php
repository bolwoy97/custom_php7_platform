                                    ...
                                    <table id="basicDataTable" class="table hover responsive display nowrap">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td><?=$with['sum']-($with['sum']/100*$with['fee']) ?></td>
                                                <td><?=$with['address']?></td>
                                                <td><?=$with['rate']?></td>
                                                <td>
                                                    <a onclick="confirmWith(<?=$with['id']?>,<?=$with['sum']?>,'<?=$usr['login']?>')"
                                                        href="#confirmOrder" data-toggle="modal"
                                                        class="fa fa-check-circle tx-success mg-r-10">confirn</a>
                                                    <a onclick="cancelWith(<?=$with['id']?>,<?=$with['sum']?>,'<?=$usr['login']?>')"
                                                        href="#cancelOrder" data-toggle="modal"
                    ...
                    <div class="row clearfix">
                        ...
                        <div class="col-12 ">
                            <div class="card mg-b-40">
                                <div class="card-header">
                                    <div class="d-flex justify-content-between align-items-center">
                                        <h6 class="card-header-title tx-13 mb-0 text-uppercase">Confirmed orders <strong>Total sum $<?=ArrayService::sumValues($confirmed)['sum']?></strong></h6> 
                                        <div class="text-right">
                                            <div class="d-flex">
                                                <div class="dropdown" data-toggle="dropdown">
                                                    <a href=""><i class="ti-more-alt"></i></a>
                                ...
                                <div class="card-body pd-0">
                                    <table id="scrollableTable" class="table hover responsive  nowrap">
                                        <thead>
                                            <tr>
                                                <th>Date</th>
                                                <th>Login</th>
                    ...
                    <div class="modal-body">
                        ...
                        <div class="d-sm-flex">
                            ...
                            <div class="flex-fill">
                                ...
                                <input name="coment" type="text" placeholder="Comment" class="alert alert-danger tx-20 tx-center " style="width:100%">
                            </div>
