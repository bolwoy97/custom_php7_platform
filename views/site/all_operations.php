            ...
            <div class="sections sections4">
                <section class="table last-operations">
                    ...
                    <div class="head">
                        ...
                        <div> <input type="text" v-on:keyup.enter="search('actions')" v-model="tabs.actions.params.search"
                        ...
                        <div class="head">
                            <nav aria-label="Page navigation example">
                                <ul class="pagination">
                                    ...
                                    <li class="page-item" v-if="tabs.actions.params.page>0">
                                        <div class="page-link"
                                            v-on:click="page('actions',tabs.actions.params.page-1)">&laquo;</div></li>

                                    <li class="page-item active"><div class="page-link" >{{tabs.actions.params.page+1}}</div>
                                    </li>

                                    <li class="page-item"  v-if="tabs.actions.params.page<tabs.actions.params.pages" disabled>
                                        <div class="page-link" 
                                            v-on:click="page('actions',tabs.actions.params.page+1)">&raquo;</div></li>
